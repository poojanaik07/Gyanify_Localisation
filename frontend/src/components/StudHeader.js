...
export default function StudHeader() {
      ...
      {showPopup && (
        <View style={styles.popupContainer}>
          ...
          >
            ...
            >
              <View style={styles.popupItem}>
                <RemixIcon name="logout-box-r-line" size={22} color="#FF4444" />
                <Text style={[styles.popupText, { color: "#FF4444" }]}>
                  Log Out
                </Text>
              </View>
            </TouchableOpacity>
