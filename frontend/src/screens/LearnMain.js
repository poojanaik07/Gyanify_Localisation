...
export default function LearnMain() {
  ...
  {
      id: 1,
      title: t("learn.course1.title"),
      description: t("learn.course1.desc"),
      instructor: "Priya Sharma",
      lectures: 5,
      duration: "07:41",
      image: require("../assets/images/Gyanify_Logo.png"),
      tags: [t("learn.tags.python"), t("learn.tags.beginner"), t("learn.tags.english"), "+2"],
    ...
    {
      id: 2,
      title: t("learn.course2.title"),
      description: t("learn.course2.desc"),
      instructor: "Dinesh Rao",
      lectures: 8,
      duration: "11:20",
      image: require("../assets/images/Gyanify_Logo.png"),
      tags: [t("learn.tags.backend"), "Flask", "API", "+3"],
    ...
    {
      id: 3,
      title: t("learn.course3.title"),
      description: t("learn.course3.desc"),
      instructor: "Anita Mehta",
      lectures: 12,
      duration: "14:10",
      image: require("../assets/images/Gyanify_Logo.png"),
      tags: ["AI/ML", t("learn.tags.english"), t("learn.tags.math"), "+1"],
      languagesAvailable: 4,
      views: 458,
      category: "AI/ML",
    },
  ...
  const [selectedCategory, setSelectedCategory] = useState(t("learn.categories.all"));
  const [search, setSearch] = useState("");

  const filteredCourses = allCourses.filter((course) => {
    const matchCat =
      selectedCategory === t("learn.categories.all") || course.category === selectedCategory;
        ...
        >
          ...
          <View style={styles.row}>
            ...
            <Text
              style={[styles.meta, { color: isDark ? "#BBD1FF" : "#555" }]}
            >
              {course.lectures} {t("learn.lectures")}
            </Text>
          ...
          <View style={styles.row}>
            ...
            >
              {t("learn.langAvailable")}  {course.languagesAvailable} {t("languages")}
            </Text>
          </View>
          ...
          >
            <Text style={styles.buttonText}>{t("learn.enrollNow")}</Text>
          </TouchableOpacity>
        </View>
      ))}
